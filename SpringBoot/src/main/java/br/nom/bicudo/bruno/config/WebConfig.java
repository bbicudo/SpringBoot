...
import br.nom.bicudo.bruno.serialization.converter.YamlJacksonToHttpMessageConverter;
...
public class WebConfig implements WebMvcConfigurer{
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		...
		// Implementação via Header param (e.g.: Accept: application/xml)
		...
		// Implementação via Query param (e.g.: /api/person/v1?mediaType=xml
